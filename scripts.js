...
function playRound() {
    ...
    if (gameResult === "win") incrementCounterById("wins-p");
    else if (gameResult === "loss") incrementCounterById("losses-p");
    else incrementCounterById("ties-p");
}
...
function isRadioSelected() {
    if (
        document.getElementById("rock-radio").checked ||
